# 02 — Auronis Health · Documentação Completa da Plataforma
...
## 1. Visão geral
Auronis Health escuta a consulta médica e gera automaticamente o **prontuário estruturado** e as **guias TISS** dos convênios, devolvendo horas/dia ao médico e reduzindo **glosas** das operadoras. Diferencial: fecha o ciclo até a guia preenchível, não apenas a transcrição.
